...
This repository stores configuration information for the Plant Phenology Ontology to run using code and logic from the [ontology-data-pipeline](https://github.com/biocodellc/ontology-data-pipeline).   To get started, choose either the "Docker Method" or "Non-Docker Method" below:  
